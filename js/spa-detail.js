...
function renderEquipements() {
    ...
    equipements.forEach(function (equip, idx) {
        ...
        item.innerHTML =
            ...
            '<div class="custom-equip-fields">' +
                ...
                '<div class="field-group">' + PhotoManager.createPhotoWidget("spa_" + currentSpa.numero + "_customeq_" + equip.nom) + '</div>' +
            '</div>';
    ...
    customEquipementsList.querySelectorAll(".custom-equip-rename-btn").forEach(function (btn) {
        btn.addEventListener("click", function () {
            ...
            var oldKey = "spa_" + currentSpa.numero + "_customeq_" + ancienNom;
            var newKey = "spa_" + currentSpa.numero + "_customeq_" + nouveauNom;
...
function renderEclairages() {
    ...
    eclairages.forEach(function (item, index) {
        ...
        row.innerHTML =
            ...
            '<div class="row-photo-group row-photo-fullwidth">' + PhotoManager.createMultiPhotoWidget("spa_" + currentSpa.numero + "_eclairage_" + index) + '</div>';
