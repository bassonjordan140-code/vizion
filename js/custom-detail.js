...
function renderEclairages() {
    ...
    eclairages.forEach(function (item, index) {
        ...
        row.innerHTML =
            ...
            '<div class="row-photo-group row-photo-fullwidth">' + PhotoManager.createMultiPhotoWidget(currentCustom.secteurId + "_" + currentCustom.numero + "_eclairage_" + index) + '</div>';
